...
Due to high levels of literacy in out data sample. When we control for everything else, Literate heads of households have about 0.1576 children more than non-literate heads of household.This relationship is significant at a 95% confidence level.
...
This Non-linear transformation is a better model, because it has a higher significance level (98%) in the Doubled Income coefficient. This means that with a 98% confidence we can say that doubling your income will have an effect of ....  
